...
- הכתוביות מופיעות כג'יבריש מוזר (קידוד ישן של Windows-1255).
- הכתוביות מלאות ברעשי רקע מעצבנים כמו `[מוזיקה דרמטית]` או פרסומות של אתרי כתוביות (Torec, OpenSubtitles, טלגרם).
