...
toolkit.py
----------
Universal Command-Line Interface (CLI) for the Subtitle Master Toolkit.
Works for ANY movie or TV series.
...
def main():
    parser = argparse.ArgumentParser(
        prog="toolkit.py",
        description="Universal Subtitle Translation, BiDi & Synchronization Toolkit for Movies and TV Series"
    )
